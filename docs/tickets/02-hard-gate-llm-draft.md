...
- **2026-08-13 手動已驗證**：首頁有 AI 免責／草稿相關提示。
- **2026-08-13 缺陷收斂**：韓文等來源若 LLM 把原文腳本塞進 `displayText`，硬閘仍拒收，但錯誤改為「近似音請用注音／羅馬拼音／漢字，不可含原文腳本…請重新產生」；另允許注音腳本；Prompt 補「禁止來源語原文腳本」核對項。
